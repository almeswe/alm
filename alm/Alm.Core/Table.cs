...
namespace alm.Core.VariableTable
{
    ...
    public sealed class Table
    {
        ...
        private static IReadOnlyList<TableFunction> BaseFunctions = new List<TableFunction>()
        {
            ...
            new TableFunction("tostrf", new String(), new TableFunctionArgument[] { new TableFunctionArgument(new Real32(), 1) }, 1),
            new TableFunction("tofloat",new Real32(), new TableFunctionArgument[]{ new TableFunctionArgument(new String(), 1) }, 1),
