...
## Installation
 ...
 Open the latest release (or simply [click](https://github.com/Almeswe/alm/releases/download/v.2.0.0/almc.v2.0.0.zip) here) and download the zip with libs,tests and binary.
...
## Examples
  ...
  All those examples yon can find [here](examples).
